...
function getQuestionText(questionId: string, language: string = 'en'): string {
  const questionTranslations = {
    en: {
      ...
      'stakeholder-engagement': 'How well do you engage key stakeholders in AI initiatives?',
    ...
    bs: {
      ...
      'stakeholder-engagement': 'Koliko dobro angažujete ključne nositelje odgovornosti u AI inicijativama?',
