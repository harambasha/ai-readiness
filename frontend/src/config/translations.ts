export const translations = {
  en: {
    ...
    // Recommendations
    yourOrganizationIsInTheEarlyStagesOfAiReadinessFocusOnDevelopingFoundationalCapabilitiesAndBuildingBasicAiAwareness: 'Your organization is in the early stages of AI readiness. Focus on developing foundational capabilities and building basic AI awareness.',
    youReMakingProgressButThereSRoomForImprovementPrioritizeDataInfrastructureAndTalentDevelopment: 'You\'re making progress but there\'s room for improvement. Prioritize data infrastructure and talent development.',
    youReWellOnYourWayConsiderExpandingYourAiInitiativesAndStrengtheningGovernanceFrameworks: 'You\'re well on your way! Consider expanding your AI initiatives and strengthening governance frameworks.',
    strongAiReadinessFocusOnOptimizationAndScalingYourAiCapabilities: 'Strong AI readiness! Focus on optimization and scaling your AI capabilities.',
  ...
  bs: {
    ...
    // Recommendations
    yourOrganizationIsInTheEarlyStagesOfAiReadinessFocusOnDevelopingFoundationalCapabilitiesAndBuildingBasicAiAwareness: 'Vaša organizacija je u ranim fazama spremnosti za AI. Fokusirajte se na razvoj osnovnih sposobnosti i izgradnju osnovne AI svijesti.',
    youReMakingProgressButThereSRoomForImprovementPrioritizeDataInfrastructureAndTalentDevelopment: 'Napredujete, ali ima prostora za poboljšanje. Prioritetizirajte infrastrukturu podataka i razvoj talenata.',
    youReWellOnYourWayConsiderExpandingYourAiInitiativesAndStrengtheningGovernanceFrameworks: 'Dobro ste na putu! Razmislite o proširenju vaših AI inicijativa i jačanju okvira upravljanja.',
    strongAiReadinessFocusOnOptimizationAndScalingYourAiCapabilities: 'Jaka spremnost za AI! Fokusirajte se na optimizaciju i skaliranje vaših AI sposobnosti.',
