...
function QuestionStep({
  ...
  return (
    <div className="p-10">
      <h2 className="text-2xl font-bold text-[#1A1F22] mb-4">{question.text}</h2>
      ...
      {question.type === 'slider' && question.slider && (
        <div className="bg-[#F5F6FA] p-8">
          <div className="flex justify-between text-sm text-[#687177] mb-4">
              ...
              <button
                ...
                className={`py-2 px-4 text-sm font-medium transition-all duration-200 ${
                  currentAnswer?.sliderValue === value
                    ...
                    : 'bg-white text-[#687177] hover:bg-[#F5F6FA] border-2 border-[#E7E9EC]'
                }`}
              >
                {label}
              </button>
